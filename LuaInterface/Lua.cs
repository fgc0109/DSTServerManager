...
{
    /// <summary>
    /// LuaInterface关键类型,将Lua API面向对象包装 原作者Fabio Mascarenhas
    /// </summary>
    public class Lua : IDisposable
    {
        ...
        {
            object err = translator.GetStackObject(luaState, -1);
        ...
        public object this[string fullPath]
        {
            get
            {
                ...
                returnValue = translator.GetStackObject(luaState, -1);
                if (path.Length > 1)
                {
        ...
        public ListDictionary GetTableDict(LuaTable table)
        {
            ...
            {
                dict[translator.GetStackObject(luaState, -2)] = translator.GetStackObject(luaState, -1);
        ...
        internal object rawGetObject(int reference, string field)
        {
            ...
            object obj = translator.GetStackObject(luaState, -1);
            LuaDLL.lua_settop(luaState, oldTop);
            return obj;
        }
        /*
        ...
        internal object getObject(int reference, object field)
        {
            ...
            LuaDLL.lua_gettable(luaState, -2);
            object returnValue = translator.GetStackObject(luaState, -1);
            LuaDLL.lua_settop(luaState, oldTop);
            return returnValue;
        }
        /*
        ...
        public LuaFunction RegisterFunction(string path, object target, MethodBase function /*MethodInfo function*/)  //CP: Fix for struct constructor by Alexander Kappner (link: http://luaforge.net/forum/forum.php?thread_id=2859&forum_id=145)
        {
            ...
            this[path] = translator.GetStackObject(luaState, -1);
